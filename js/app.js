...
$(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
        ...
        eventRender: function(event, element) {             
			...
			tiptext += '</em>';
            if (event.location  && event.location.trim().length) tiptext += '<br><u>Lieu</u> : ' + event.location;
            if (event.description && event.description.trim().length) tiptext += '<br><u>Description</u> : ' + event.description;
